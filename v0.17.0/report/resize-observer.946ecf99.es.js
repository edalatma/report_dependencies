...
var X = (function () {
  ...
  _ = /auto|scroll/,
  ae = /^tb|vertical/,
  ve = /msie|trident/i.test(l.navigator && l.navigator.userAgent),
  a = function (e) {
  ...
  G = function (e, t) {
    if ((t === void 0 && (t = !1), x.has(e) && !t)) return x.get(e);
    if (q(e)) return x.set(e, I), I;
    var r = getComputedStyle(e),
      i = S(e) && e.ownerSVGElement && e.getBBox(),
      n = !ve && r.boxSizing === "border-box",
      s = ae.test(r.writingMode || ""),
      o = !i && _.test(r.overflowY || ""),
      u = !i && _.test(r.overflowX || ""),
      h = i ? 0 : a(r.paddingTop),
      v = i ? 0 : a(r.paddingRight),
      w = i ? 0 : a(r.paddingBottom),
      f = i ? 0 : a(r.paddingLeft),
      Y = i ? 0 : a(r.borderTopWidth),
      K = i ? 0 : a(r.borderRightWidth),
      Q = i ? 0 : a(r.borderBottomWidth),
      Z = i ? 0 : a(r.borderLeftWidth),
      C = f + v,
      D = h + w,
      y = Z + K,
      T = Y + Q,
      k = u ? e.offsetHeight - T - e.clientHeight : 0,
      N = o ? e.offsetWidth - y - e.clientWidth : 0,
      $ = n ? C + y : 0,
      ee = n ? D + T : 0,
      b = i ? i.width : a(r.width) - $ - N,
      g = i ? i.height : a(r.height) - ee - k,
      te = b + C + N + y,
      re = g + D + k + T,
      A = Object.freeze({
        devicePixelContentBoxSize: d(
  ...
  ce = (function () {
    function e(t) {
      ...
      (this.target = t),
        ...
        (this.borderBoxSize = [r.borderBoxSize]),
        (this.contentBoxSize = [r.contentBoxSize]),
        (this.devicePixelContentBoxSize = [r.devicePixelContentBoxSize]);
    }
    return e;
  })(),
  J = function (e) {
    ...
    c.forEach(function (o) {
      if (o.activeTargets.length !== 0) {
        ...
        o.activeTargets.forEach(function (v) {
          var w = new ce(v.target),
            f = J(v.target);
          u.push(w),
            (v.lastReportedSize = j(v.target, v.observedBox)),
            f < e && (e = f);
        }),
          t.push(function () {
  ...
  W = function (e) {
    c.forEach(function (r) {
      r.activeTargets.splice(0, r.activeTargets.length),
        ...
        r.observationTargets.forEach(function (n) {
          n.isActive() &&
            (J(n.target) > e
              ? r.activeTargets.push(n)
              : r.skippedTargets.push(n));
        });
    });
  },
  he = function () {
  ...
  Oe = (function () {
    function e(t, r) {
      (this.target = t),
        (this.observedBox = r || p.CONTENT_BOX),
    ...
    return (
      (e.prototype.isActive = function () {
        ...
        return (
          ze(this.target) && (this.lastReportedSize = t),
  ...
  O = (function () {
    ...
    return (
      ...
      (e.observe = function (t, r, i) {
        var n = z.get(t),
          s = n.observationTargets.length === 0;
        V(n.observationTargets, r) < 0 &&
          (s && c.push(n),
          n.observationTargets.push(new Oe(r, i && i.box)),
          H(1),
          B.schedule());
      }),
      (e.unobserve = function (t, r) {
        var i = z.get(t),
          n = V(i.observationTargets, r),
          s = i.observationTargets.length === 1;
        n >= 0 &&
          (s && c.splice(c.indexOf(i), 1),
...
export { we as ResizeObserver, ce as ResizeObserverEntry };
