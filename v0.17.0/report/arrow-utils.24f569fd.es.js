...
var Ms = (i, t, e) =>
  t in i
    ? Ts(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (i[t] = e);
...
function hn(i) {
  ...
  if (i && typeof i.length == "number")
    return {
      next: function () {
        return (
          i && n >= i.length && (i = void 0), { value: i && i[n++], done: !i }
        );
      },
    };
  throw new TypeError(
...
function Ot(i, t, e) {
  ...
  function c(A) {
    A.value instanceof S
      ? Promise.resolve(A.value.v).then(u, d)
      : h(s[0][2], A);
  }
  function u(A) {
    a("next", A);
...
function le(i) {
  ...
  return t
    ? t.call(i)
    : ((i = typeof hn == "function" ? hn(i) : i[Symbol.iterator]()),
      (e = {}),
      n("next"),
      n("throw"),
      n("return"),
...
const Ls = new TextDecoder("utf-8"),
  Ri = (i) => Ls.decode(i),
  Us = new TextEncoder(),
  $i = (i) => Us.encode(i),
  [Le, zc] = (() => {
  ...
  xs = (i) => typeof i == "boolean",
  H = (i) => typeof i == "function",
  ft = (i) => i != null && Object(i) === i,
  Fe = (i) => ft(i) && H(i.then),
  wi = (i) => ft(i) && H(i[Symbol.iterator]),
  Wi = (i) => ft(i) && H(i[Symbol.asyncIterator]),
  xi = (i) => ft(i) && ft(i.schema),
  xn = (i) => ft(i) && "done" in i && "value" in i,
  En = (i) => ft(i) && H(i.stat) && Rs(i.fd),
  Cn = (i) => ft(i) && Yi(i.body),
  Vn = (i) => "_getDOMStream" in i && "_getNodeStream" in i,
  Yi = (i) => ft(i) && H(i.cancel) && H(i.getReader) && !Vn(i),
  zn = (i) => ft(i) && H(i.read) && H(i.pipe) && xs(i.readable) && !Vn(i),
  Es = (i) =>
    ft(i) &&
    H(i.clear) &&
    H(i.bytes) &&
    ...
    H(i.setPosition) &&
    H(i.capacity) &&
    H(i.getBufferIdentifier) &&
    H(i.createLong),
  Ji = typeof SharedArrayBuffer < "u" ? SharedArrayBuffer : ArrayBuffer;
function Cs(i) {
  const t = i[0] ? [i[0]] : [];
  let e, n, r, s;
...
function fn(i, t, e = 0, n = t.byteLength) {
  const r = i.byteLength,
    s = new Uint8Array(i.buffer, i.byteOffset, r),
    o = new Uint8Array(t.buffer, t.byteOffset, Math.min(n, r));
  return s.set(o, e), i;
}
function Nt(i, t) {
  const e = Cs(i),
    n = e.reduce((d, h) => d + h.byteLength, 0);
  let r,
    s,
    o,
    a = 0,
...
function R(i, t) {
  ...
  return e instanceof i
    ? i === Uint8Array
      ? new i(e.buffer, e.byteOffset, e.byteLength)
      : e
    : e
    ? (typeof e == "string" && (e = $i(e)),
      e instanceof ArrayBuffer
        ...
        ? e.byteLength <= 0
          ? new i(0)
          : new i(e.buffer, e.byteOffset, e.byteLength / i.BYTES_PER_ELEMENT)
        : i.from(e))
    : new i(0);
}
const Be = (i) => R(Int32Array, i),
  N = (i) => R(Uint8Array, i),
  Ei = (i) => (i.next(), i);
function* Vs(i, t) {
  const e = function* (r) {
...
function kn(i, t) {
  return Ot(this, arguments, function* () {
    if (Fe(t)) return yield S(yield S(yield* je(le(kn(i, yield S(t))))));
    const n = function (o) {
        return Ot(this, arguments, function* () {
          ...
          le(
            Ei(
              (function (o) {
                return Ot(this, arguments, function* () {
                  let a = null;
                  do a = yield S(o.next(yield yield S(R(i, a))));
                  while (!a.done);
                });
...
function* Ps(i) {
  ...
  try {
    do
      if (
        (({ done: t, value: r } = Number.isNaN(o - a)
          ? u.next()
          : u.next(o - a)),
        !t && r.byteLength > 0 && (n.push(r), (a += r.byteLength)),
        t || o <= a)
      )
  ...
  return Ot(this, arguments, function* () {
    ...
    try {
      do
        if (
          (({ done: e, value: s } = Number.isNaN(a - c)
            ? yield S(d.next())
            : yield S(d.next(a - c))),
          !e && s.byteLength > 0 && (r.push(s), (c += s.byteLength)),
          e || a <= c)
        )
          do ({ cmd: o, size: a } = yield yield S(u()));
          while (a < c);
      while (!e);
    } catch (h) {
      ...
      n === !1 &&
        ...
        (yield S(d.return(new Uint8Array(0))));
    }
    return yield S(null);
  });
}
      ...
      do
        if (
          (({ done: e, value: s } = Number.isNaN(a - c)
            ? yield S(d.read())
            : yield S(d.read(a - c))),
          !e && s.byteLength > 0 && (r.push(N(s)), (c += s.byteLength)),
          e || a <= c)
        )
          do ({ cmd: o, size: a } = yield yield S(u()));
          while (a < c);
  ...
  return Ot(this, arguments, function* () {
    ...
    try {
      ...
      do {
        if (
          ((e[2] = Di(i, "readable")),
          ([n, s] = yield S(Promise.race(e.map((j) => j[2])))),
          n === "error")
        )
          break;
        if (
          ((r = n === "end") ||
            (Number.isFinite(a - c)
              ? ((d = N(i.read(a - c))),
                d.byteLength < a - c && (d = N(i.read())))
              : (d = N(i.read())),
            d.byteLength > 0 && (u.push(d), (c += d.byteLength))),
          r || a <= c)
        )
          do ({ cmd: o, size: a } = yield yield S(h()));
          while (a < c);
      } while (!r);
    } finally {
    ...
    function A(j, nt) {
      return (
        (d = u = null),
        new Promise((Fi, Ds) => {
          for (const [se, Ns] of j) i.off(se, Ns);
          try {
            const se = i.destroy;
...
var Yt;
(function (i) {
  (i[(i.YEAR_MONTH = 0)] = "YEAR_MONTH"),
    (i[(i.DAY_TIME = 1)] = "DAY_TIME"),
    (i[(i.MONTH_DAY_NANO = 2)] = "MONTH_DAY_NANO");
})(Yt || (Yt = {}));
var L;
(function (i) {
  (i[(i.NONE = 0)] = "NONE"),
...
function Oe(i) {
  ...
  return typeof i[Symbol.toPrimitive] == "function"
    ...
    ? i instanceof Le || i instanceof Ue
      ? `[${[...i].map((t) => Oe(t))}]`
      : `[${i}]`
    : ArrayBuffer.isView(i)
    ? `[${i}]`
    : JSON.stringify(i, (t, e) => (typeof e == "bigint" ? `${e}` : e));
}
const Ks = Symbol.for("isArrowBigNum");
function bt(i, ...t) {
  return t.length === 0
    ? Object.setPrototypeOf(R(this.TypedArray, i), this.constructor.prototype)
    : Object.setPrototypeOf(
        new this.TypedArray(i, ...t),
...
Object.setPrototypeOf(De.prototype, Object.create(Uint32Array.prototype));
Object.assign(ue.prototype, bt.prototype, {
  constructor: ue,
  signed: !0,
  TypedArray: Int32Array,
  BigIntArray: Le,
});
Object.assign(de.prototype, bt.prototype, {
  constructor: de,
  signed: !1,
...
function jn(i) {
  const { buffer: t, byteOffset: e, length: n, signed: r } = i,
    s = new Ue(t, e, n),
    o = r && s[s.length - 1] & (BigInt(1) << BigInt(63));
  let a = BigInt(o ? 1 : 0),
    c = BigInt(0);
  if (o) {
    for (const u of s) a += ~u * (BigInt(1) << (BigInt(32) * c++));
    a *= BigInt(-1);
  } else for (const u of s) a += u * (BigInt(1) << (BigInt(32) * c++));
  return a;
}
const Ye = (i) =>
    i.byteLength === 8
      ? `${new i.BigIntArray(i.buffer, i.byteOffset, 1)[0]}`
      : Pn(i),
  Gs = (i) =>
    i.byteLength === 8
      ? new i.BigIntArray(i.buffer, i.byteOffset, 1)[0]
...
function yt(i) {
  if (
    typeof i == "bigint" &&
    (i < Number.MIN_SAFE_INTEGER || i > Number.MAX_SAFE_INTEGER)
  )
...
Te[Jn] = ((i) => ((i.precision = null), (i[Symbol.toStringTag] = "Float")))(
  Te.prototype
);
class Je extends f {
  constructor() {
...
Me[Xn] = ((i) => (
  (i.unit = null), (i.bitWidth = null), (i[Symbol.toStringTag] = "Time")
))(Me.prototype);
class qe extends f {
  constructor(t, e) {
...
Qe[er] = ((i) => ((i.children = null), (i[Symbol.toStringTag] = "List")))(
  Qe.prototype
);
class K extends f {
  constructor(t) {
...
K[ir] = ((i) => ((i.children = null), (i[Symbol.toStringTag] = "Struct")))(
  K.prototype
);
class ti extends f {
  constructor(t, e, n) {
...
ei[rr] = ((i) => (
  (i.byteWidth = null),
  (i.ArrayType = Uint8Array),
  (i[Symbol.toStringTag] = "FixedSizeBinary")
))(ei.prototype);
class ii extends f {
  constructor(t, e) {
...
ii[sr] = ((i) => (
  (i.children = null),
  (i.listSize = null),
  (i[Symbol.toStringTag] = "FixedSizeList")
))(ii.prototype);
class ni extends f {
  constructor(t, e = !1) {
...
function qs(i, t, e = !0) {
  return typeof t == "number"
    ? ae(i, t, e)
    : typeof t == "string" && t in l
    ? ae(i, l[t], e)
    : t && t instanceof f
    ? ae(i, pn(t), e)
    : (t == null ? void 0 : t.type) && t.type instanceof f
    ? ae(i, pn(t.type), e)
    : ae(i, l.NONE, e);
}
function ae(i, t, e = !0) {
...
const cr = new Float64Array(1),
  oe = new Uint32Array(cr.buffer);
function lr(i) {
  const t = (i & 31744) >> 10,
    e = (i & 1023) / 1024,
    n = Math.pow(-1, (i & 32768) >> 15);
  switch (t) {
    case 31:
...
function Xs(i) {
  ...
  let e = oe[1] & 2146435072,
    n = 0;
  return (
    e >= 1089470464
      ? oe[0] > 0
        ? (e = 31744)
        : ((e = (e & 2080374784) >> 16), (n = (oe[1] & 1048575) >> 10))
      : e <= 1056964608
      ? ((n = 1048576 + (oe[1] & 1048575)),
        (n = (1048576 + (n << ((e >> 20) - 998))) >> 21),
        (e = 0))
      : ((e = (e - 1056964608) >> 10), (n = ((oe[1] & 1048575) + 512) >> 10)),
    t | e | (n & 65535)
  );
}
class _ extends O {}
function I(i) {
  return (t, e, n) => {
    if (t.setValid(e, n != null)) return i(t, e, n);
  };
}
const Qs = (i, t, e) => {
  ...
  Ki = (i, t, e) => {
    (i[t] = Math.trunc(e % 4294967296)),
      (i[t + 1] = Math.trunc(e / 4294967296));
  },
  to = (i, t, e) => {
    (i[t] = Math.trunc((e * 1e3) % 4294967296)),
      (i[t + 1] = Math.trunc((e * 1e3) / 4294967296));
  },
  eo = (i, t, e) => {
    (i[t] = Math.trunc((e * 1e6) % 4294967296)),
      (i[t + 1] = Math.trunc((e * 1e6) / 4294967296));
  },
  ur = (i, t, e, n) => {
    if (e + 1 < t.length) {
      const { [e]: r, [e + 1]: s } = t;
  ...
  so = ({ values: i, valueOffsets: t }, e, n) => ur(i, t, e, n),
  oo = ({ values: i, valueOffsets: t }, e, n) => {
    ur(i, t, e, $i(n));
  },
  ao = (i, t, e) => {
    i.type.unit === Vt.DAY ? hr(i, t, e) : fr(i, t, e);
  },
  pr = ({ values: i }, t, e) => Ki(i, t * 2, e / 1e3),
  yr = ({ values: i }, t, e) => Ki(i, t * 2, e),
  mr = ({ values: i }, t, e) => to(i, t * 2, e),
  br = ({ values: i }, t, e) => eo(i, t * 2, e),
  co = (i, t, e) => {
    switch (i.type.unit) {
      case D.SECOND:
        return pr(i, t, e);
  ...
  ho = (i, t, e) => {
    const n = i.children[0],
      ...
      s = ut.getVisitFn(n);
    if (Array.isArray(e))
      for (let o = -1, a = r[t], c = r[t + 1]; a < c; ) s(n, a++, e[++o]);
    else
      for (let o = -1, a = r[t], c = r[t + 1]; a < c; ) s(n, a++, e.get(++o));
  },
  fo = (i, t, e) => {
    const n = i.children[0],
      { valueOffsets: r } = i,
    ...
    for (const u of c) if ((s(n, o, u), ++o >= a)) break;
  },
  po = (i, t) => (e, n, r, s) => n && e(n, i, t[s]),
  yo = (i, t) => (e, n, r, s) => n && e(n, i, t.get(s)),
  mo = (i, t) => (e, n, r, s) => n && e(n, i, t.get(r.name)),
  bo = (i, t) => (e, n, r, s) => n && e(n, i, t[r.name]),
  go = (i, t, e) => {
    const n = i.type.children.map((s) => ut.getVisitFn(s.type)),
      r =
        e instanceof Map
          ? mo(t, e)
          : e instanceof U
  ...
  Ir = (i, t, e) => {
    const n = i.type.typeIdToChildIndex[i.typeIds[t]],
      r = i.children[n];
  ...
  Io = (i, t, e) => {
    const { stride: n } = i,
      ...
      s = ut.getVisitFn(r);
    if (Array.isArray(e))
      for (let o = -1, a = t * n; ++o < n; ) s(r, a + o, e[o]);
    else for (let o = -1, a = t * n; ++o < n; ) s(r, a + o, e.get(o));
  };
...
class Bo {
  ...
  set(t, e, n) {
    ...
    return r !== -1
      ? (ut.visit(t[dt].children[r], t[he], n), Reflect.set(t, e, n))
...
const Ao = (i, t) => 864e5 * i[t],
  qi = (i, t) => 4294967296 * i[t + 1] + (i[t] >>> 0),
  Fo = (i, t) => 4294967296 * (i[t + 1] / 1e3) + (i[t] >>> 0) / 1e3,
  Oo = (i, t) => 4294967296 * (i[t + 1] / 1e6) + (i[t] >>> 0) / 1e6,
  Fr = (i) => new Date(i),
  Do = (i, t) => Fr(Ao(i, t)),
  No = (i, t) => Fr(qi(i, t)),
  To = (i, t) => null,
  ...
  Dr = ({ values: i }, t) => Do(i, t),
  Nr = ({ values: i }, t) => No(i, t * 2),
  Zt = ({ stride: i, values: t }, e) => t[i * e],
  Lo = ({ stride: i, values: t }, e) => lr(t[i * e]),
  Tr = ({ values: i }, t) => i[t],
  Uo = ({ stride: i, values: t }, e) => t.subarray(i * e, i * (e + 1)),
  Ro = ({ values: i, valueOffsets: t }, e) => Or(i, t, e),
  xo = ({ values: i, valueOffsets: t }, e) => {
    const n = Or(i, t, e);
    return n !== null ? Ri(n) : null;
  },
  Eo = ({ values: i }, t) => i[t],
  Co = ({ type: i, values: t }, e) =>
    i.precision !== G.HALF ? t[e] : lr(t[e]),
  Vo = (i, t) => (i.type.unit === Vt.DAY ? Dr(i, t) : Nr(i, t)),
  Mr = ({ values: i }, t) => 1e3 * qi(i, t * 2),
  Lr = ({ values: i }, t) => qi(i, t * 2),
  Ur = ({ values: i }, t) => Fo(i, t * 2),
  Rr = ({ values: i }, t) => Oo(i, t * 2),
  zo = (i, t) => {
    switch (i.type.unit) {
      case D.SECOND:
        return Mr(i, t);
  ...
  jo = ({ values: i, stride: t }, e) =>
    Hi.decimal(i.subarray(t * e, t * (e + 1))),
  Po = (i, t) => {
    const { valueOffsets: e, stride: n, children: r } = i,
      { [t * n]: s, [t * n + 1]: o } = e,
      c = r[0].slice(s, o - s);
    return new U([c]);
  },
  $o = (i, t) => {
    const { valueOffsets: e, children: n } = i,
      { [t]: r, [t + 1]: s } = e,
      o = n[0];
    return new Xi(o.slice(r, s - r));
  },
  Wo = (i, t) => new Zi(i, t),
  Yo = (i, t) => (i.type.mode === pt.Dense ? zr(i, t) : kr(i, t)),
  zr = (i, t) => {
    const e = i.type.typeIdToChildIndex[i.typeIds[t]],
      n = i.children[e];
  ...
  Jo = (i, t) => {
    var e;
    return (e = i.dictionary) === null || e === void 0
      ? void 0
      : e.get(i.values[t]);
  },
  Ho = (i, t) => (i.type.unit === Yt.DAY_TIME ? jr(i, t) : Pr(i, t)),
  jr = ({ values: i }, t) => i.subarray(2 * t, 2 * (t + 1)),
  Pr = ({ values: i }, t) => {
    const e = i[t],
      n = new Int32Array(2);
...
class Xi {
  constructor(t) {
    return (
      (this[_t] = new U([t.children[0]]).memoize()),
      (this[fe] = t.children[1]),
      new Proxy(this, new Zo())
    );
  }
  [Symbol.iterator]() {
  ...
  toJSON() {
    const t = this[_t],
      e = this[fe],
      n = {};
    for (let r = -1, s = t.length; ++r < s; ) n[t.get(r)] = Q.visit(e, r);
    return n;
  }
  toString() {
    return `{${[...this].map(([t, e]) => `${Oe(t)}: ${Oe(e)}`).join(", ")}}`;
      ...
      : (this.keyIndex++,
        {
          ...
          value: [this.keys.get(t), Q.visit(this.vals, t)],
        });
  }
}
class Zo {
  ...
  set(t, e, n) {
    ...
    return r !== -1
      ? (ut.visit(Reflect.get(t, fe), r, n), Reflect.set(t, e, n))
      : Reflect.has(t, e)
      ? Reflect.set(t, e, n)
      : !1;
  }
...
const mn = (i) => i !== i;
function Ie(i) {
  if (typeof i !== "object" || i === null) return mn(i) ? mn : (e) => e === i;
...
function qo(i) {
  const t = [];
  for (let e = -1, n = i.length; ++e < n; ) t[e] = Ie(i[e]);
  return Ii(t);
}
function Xo(i) {
  let t = -1;
  const e = [];
  for (const n of i.values()) e[++t] = Ie(n);
  return Ii(e);
}
function Qo(i) {
  const t = [];
  for (let e = -1, n = i.length; ++e < n; ) t[e] = Ie(i.get(e));
  return Ii(t);
}
function ta(i, t = !1) {
  ...
  const n = [];
  for (let r = -1, s = e.length; ++r < s; ) n[r] = Ie(i[e[r]]);
  return Ii(n, e);
}
function Ii(i, t) {
  return (e) => {
...
function ea(i, t) {
  ...
  for (let n = -1; ++n < e; ) if (!i[n](t[n])) return !1;
  return !0;
}
function ia(i, t) {
  const e = i.length;
  if (t.length !== e) return !1;
  for (let n = -1; ++n < e; ) if (!i[n](t.get(n))) return !1;
  return !0;
}
function bn(i, t, e) {
  ...
  for (
    ...
    !d.done &&
    !c.done &&
    !(u.value !== d.value || !i[o](c.value));
    ++o, u = n.next(), d = r.next(), c = s.next()
  );
  return o === a && u.done && d.done && c.done
    ? !0
    : (n.return && n.return(),
      r.return && r.return(),
      s.return && s.return(),
  ...
  if (i > 0 || e.byteLength < n) {
    ...
    return (
      r.set(
        i % 8 === 0
          ? e.subarray(i >> 3)
          : Ci(new Qi(e, i, t, null, Wr)).subarray(0, n)
      ),
      r
    );
  }
...
function Vi(i, t, e) {
  ...
  if (e - t < 8) {
    let s = 0;
    for (const o of new Qi(i, t, e - t, i, na)) s += o;
    return s;
  }
  const n = (e >> 3) << 3,
    r = t + (t % 8 === 0 ? 0 : 8 - (t % 8));
...
function sa(i, t, e) {
  ...
  const s = new DataView(i.buffer, i.byteOffset, i.byteLength),
    o = e === void 0 ? i.byteLength : r + e;
  for (; o - r >= 4; ) (n += Ni(s.getUint32(r))), (r += 4);
  for (; o - r >= 2; ) (n += Ni(s.getUint16(r))), (r += 2);
  for (; o - r >= 1; ) (n += Ni(s.getUint8(r))), (r += 1);
  return n;
}
function Ni(i) {
  let t = Math.trunc(i);
...
class E {
  ...
  get nullCount() {
    ...
    return (
      t <= oa &&
        (e = this.nullBitmap) &&
        (this._nullCount = t =
          this.length - Vi(e, this.offset, this.offset + this.length)),
      t
    );
  }
  constructor(t, e, n, r, s, o = [], a) {
    (this.type = t),
      ...
      (this._nullCount = Math.floor(Math.max(r || 0, -1)));
    let c;
    s instanceof E
  ...
  setValid(t, e) {
    ...
    if (!this.nullBitmap || this.nullBitmap.byteLength <= t >> 3) {
      const { nullBitmap: c } = this._changeLengthAndBackfillNullBitmap(
        this.length
      );
      Object.assign(this, { nullBitmap: c, _nullCount: 0 });
    }
    const { nullBitmap: n, offset: r } = this,
      s = (r + t) >> 3,
      o = (r + t) % 8,
      a = (n[s] >> o) & 1;
    return (
      e
        ? a === 0 && ((n[s] |= 1 << o), (this._nullCount = this.nullCount + 1))
        : a === 1 &&
  ...
  slice(t, e) {
    const { stride: n, typeId: r, children: s } = this,
      o = +(this._nullCount === 0) - 1,
      a = r === 16 ? n : 1,
      c = this._sliceBuffers(t, e, n, r);
    return this.clone(
      this.type,
      this.offset + t,
      e,
  ...
  _changeLengthAndBackfillNullBitmap(t) {
    ...
    const { length: e, nullCount: n } = this,
      r = new Uint8Array(((t + 63) & -64) >> 3).fill(255, 0, e >> 3);
    (r[e >> 3] = (1 << (e - (e & -8))) - 1),
      n > 0 && r.set(ra(this.offset, e, this.nullBitmap), 0);
  ...
  _sliceBuffers(t, e, n, r) {
    ...
    return (
      (s = o[Mt.TYPE]) && (o[Mt.TYPE] = s.subarray(t, t + e)),
      ((s = o[Mt.OFFSET]) && (o[Mt.OFFSET] = s.subarray(t, t + e + 1))) ||
        ((s = o[Mt.DATA]) &&
          (o[Mt.DATA] = r === 6 ? s : s.subarray(n * t, n * (t + e)))),
      o
    );
  }
...
class Ae extends O {
  ...
  visitBool(t) {
    const { ["type"]: e, ["offset"]: n = 0 } = t,
      r = N(t.nullBitmap),
      s = R(e.ArrayType, t.data),
      {
        ["length"]: o = s.length >> 3,
  ...
  visitList(t) {
    const { ["type"]: e, ["offset"]: n = 0, ["child"]: r } = t,
      s = N(t.nullBitmap),
      o = Be(t.valueOffsets),
      {
        ["length"]: a = o.length - 1,
  ...
  visitStruct(t) {
    const { ["type"]: e, ["offset"]: n = 0, ["children"]: r = [] } = t,
      s = N(t.nullBitmap),
      {
        length: o = r.reduce((c, { length: u }) => Math.max(c, u), 0),
        nullCount: a = t.nullBitmap ? -1 : 0,
      } = t;
  ...
  visitUnion(t) {
    const { ["type"]: e, ["offset"]: n = 0, ["children"]: r = [] } = t,
      s = N(t.nullBitmap),
      o = R(e.ArrayType, t.typeIds),
      { ["length"]: a = o.length, ["nullCount"]: c = t.nullBitmap ? -1 : 0 } =
        t;
    if (f.isSparseUnion(e)) return new E(e, n, a, c, [void 0, void 0, s, o], r);
  ...
  visitDictionary(t) {
    const { ["type"]: e, ["offset"]: n = 0 } = t,
      r = N(t.nullBitmap),
      s = R(e.indices.ArrayType, t.data),
      { ["dictionary"]: o = new U([new Ae().visit({ type: e.dictionary })]) } =
        t,
  ...
  visitFixedSizeList(t) {
    const {
        ["type"]: e,
        ["offset"]: n = 0,
        ["child"]: r = new Ae().visit({ type: e.valueType }),
      } = t,
      s = N(t.nullBitmap),
      {
        ["length"]: o = r.length / Lt(e),
        ["nullCount"]: a = t.nullBitmap ? -1 : 0,
      } = t;
    return new E(e, n, o, a, [void 0, void 0, s], [r]);
  }
  visitMap(t) {
    const {
        ["type"]: e,
        ["offset"]: n = 0,
        ["child"]: r = new Ae().visit({ type: e.childType }),
      } = t,
      s = N(t.nullBitmap),
      o = Be(t.valueOffsets),
      {
...
function tn(i, t, e, n) {
  let r = 0,
    ...
    o = t.length - 1;
  do {
    if (r >= o - 1) return e < t[o] ? n(i, r, e - t[r]) : null;
...
function Gr(i) {
  ...
  return function (n, r) {
    t = n;
    const s = this.data,
      o = typeof r != "number" ? e(s, 0, 0) : tn(s, this._offsets, r, e);
    return (t = void 0), o;
  };
}
class m extends O {}
...
function B(i, t, e) {
  ...
  if (t === null) return ca(i, e);
  const n = Q.getVisitFn(i),
    r = Ie(t);
  for (let s = (e || 0) - 1, o = i.length; ++s < o; ) if (r(n(i, s))) return s;
  return -1;
}
function Zr(i, t, e) {
  const n = Q.getVisitFn(i),
...
function w(i) {
  ...
  if (
    i.nullCount === 0 &&
    i.stride === 1 &&
    (t.typeId === l.Timestamp ||
      (t instanceof Ht && t.bitWidth !== 64) ||
      (t instanceof Me && t.bitWidth !== 64) ||
      (t instanceof Te && t.precision !== G.HALF))
  )
...
const da = ({ valueOffsets: i }, t) => 8 + (i[t + 1] - i[t]),
  ha = ({ valueOffsets: i }, t) => 8 + (i[t + 1] - i[t]),
  fa = ({ valueOffsets: i, stride: t, children: e }, n) => {
    const r = e[0],
      { [n * t]: s } = i,
      { [n * t + 1]: o } = i,
      a = Tt.getVisitFn(r.type),
      c = r.slice(s, o - s);
    let u = 8;
    for (let d = -1, h = o - s; ++d < h; ) u += a(c, d);
    return u;
  },
  pa = ({ stride: i, children: t }, e) => {
    const n = t[0],
      r = n.slice(e * i, i),
      s = Tt.getVisitFn(n.type);
    let o = 0;
    for (let a = -1, c = r.length; ++a < c; ) o += s(r, a);
    return o;
  },
  ya = (i, t) => (i.type.mode === pt.Dense ? qr(i, t) : Xr(i, t)),
  qr = ({ type: i, children: t, typeIds: e, valueOffsets: n }, r) => {
...
class U {
  constructor(t) {
    ...
    switch (s.length) {
      case 0:
        ...
        break;
      case 1: {
        const { get: a, set: c, indexOf: u, byteLength: d } = ts[o.typeId],
          h = s[0];
        (this.isValid = (A) => en(h, A)),
          (this.get = (A) => a(h, A)),
          (this.set = (A, j) => c(h, A, j)),
          (this.indexOf = (A) => u(h, A)),
          (this.getByteLength = (A) => d(h, A)),
          (this._offsets = [0, h.length]);
        break;
      }
      default:
    ...
    (this.data = s),
      ...
      (this.stride = Lt(o)),
      (this.numChildren =
        (r = (n = o.children) === null || n === void 0 ? void 0 : n.length) !==
          null && r !== void 0
          ? r
          : 0),
  ...
  get byteLength() {
    return (
      this._byteLength === -1 &&
        (this._byteLength = this.data.reduce((t, e) => t + e.byteLength, 0)),
      this._byteLength
    );
  }
  get nullCount() {
    return (
      this._nullCount === -1 && (this._nullCount = Yr(this.data)),
      this._nullCount
    );
  }
  get ArrayType() {
  ...
  concat(...t) {
    return new U(
      this.data.concat(t.flatMap((e) => e.data).flat(Number.POSITIVE_INFINITY))
    );
  }
  slice(t, e) {
    return new U(
      $r(this, t, e, ({ data: n, _offsets: r }, s, o) => Hr(n, r, s, o))
    );
  }
  toJSON() {
    return [...this];
      ...
      case l.Timestamp:
        switch (e.length) {
          ...
          default:
            return e.reduce(
              (o, { values: a, length: c }) => (
                o.array.set(a.subarray(0, c * r), o.offset),
                (o.offset += c * r),
                o
              ),
              { array: new s(n * r), offset: 0 }
            ).array;
        }
    }
    return [...this];
  ...
  getChildAt(t) {
    return t > -1 && t < this.numChildren
      ? new U(this.data.map(({ children: e }) => e[t]))
      : null;
  }
  get isMemoized() {
  ...
  memoize() {
    if (f.isDictionary(this.type)) {
      const t = new si(this.data[0].dictionary),
        e = this.data.map((n) => {
          const r = n.clone();
...
U[Qr] = ((i) => {
  (i.type = f.prototype),
    ...
    (i._nullCount = -1),
    (i._byteLength = -1),
    (i._offsets = new Uint32Array([0])),
    (i[Symbol.isConcatSpreadable] = !0);
  const t = Object.keys(l)
    .map((e) => l[e])
    .filter((e) => typeof e == "number" && e !== l.NONE);
  for (const e of t) {
    const n = Q.getVisitFnByTypeId(e),
      r = ut.getVisitFnByTypeId(e),
      s = ri.getVisitFnByTypeId(e),
      o = Tt.getVisitFnByTypeId(e);
    (ts[e] = { get: n, set: r, indexOf: s, byteLength: o }),
      (es[e] = Object.create(i, {
        isValid: { value: pe(en) },
...
class zi {
  ...
  static createBlock(t, e, n, r) {
    return (
      t.prep(8, 24),
      t.writeInt64(BigInt(r != null ? r : 0)),
      t.pad(4),
      t.writeInt32(n),
      t.writeInt64(BigInt(e != null ? e : 0)),
      t.offset()
    );
  }
}
const Ti = 2,
  ...
  x = 4,
  Pt = new Int32Array(2),
  _n = new Float32Array(Pt.buffer),
  vn = new Float64Array(Pt.buffer),
  ze = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;
var ki;
(function (i) {
  (i[(i.UTF8_BYTES = 1)] = "UTF8_BYTES"),
    (i[(i.UTF16_STRING = 2)] = "UTF16_STRING");
})(ki || (ki = {}));
class Kt {
  constructor(t) {
    (this.bytes_ = t),
  ...
  readFloat64(t) {
    return (
      (Pt[ze ? 0 : 1] = this.readInt32(t)),
      (Pt[ze ? 1 : 0] = this.readInt32(t + 4)),
      vn[0]
    );
  }
  writeInt8(t, e) {
  ...
  writeFloat64(t, e) {
    (vn[0] = e),
      this.writeInt32(t, Pt[ze ? 0 : 1]),
      this.writeInt32(t + 4, Pt[ze ? 1 : 0]);
  }
  getBufferIdentifier() {
  ...
  __has_identifier(t) {
    ...
    for (let e = 0; e < Ut; e++)
      if (t.charCodeAt(e) != this.readInt8(this.position() + vt + e)) return !1;
    return !0;
  }
...
class Si {
  ...
  prep(t, e) {
    ...
    for (; this.space < n + t + e; ) {
      ...
      (this.bb = Si.growByteBuffer(this.bb)),
        (this.space += this.bb.capacity() - r);
    }
    this.pad(n);
  }
  pad(t) {
    ...
    t: for (e = 0; e < this.vtables.length; e++) {
      ...
      if (s == this.bb.readInt16(c)) {
        for (let u = Ti; u < s; u += Ti)
          if (this.bb.readInt16(a + u) != this.bb.readInt16(c + u)) continue t;
        o = this.vtables[e];
        break;
      }
    }
  ...
  finish(t, e, n) {
    ...
    if (e) {
      ...
      if ((this.prep(this.minalign, vt + Ut + r), s.length != Ut))
        throw new Error("FlatBuffers: file identifier must be length " + Ut);
      for (let o = Ut - 1; o >= 0; o--) this.writeInt8(s.charCodeAt(o));
    }
    this.prep(this.minalign, vt + r),
      this.addOffset(t),
  ...
  createSharedString(t) {
    if (!t) return 0;
    if (
      (this.string_maps || (this.string_maps = /* @__PURE__ */ new Map()),
  ...
  createObjectOffsetList(t) {
    ...
    for (let n = 0; n < t.length; ++n) {
      const r = t[n];
      if (r !== null) e.push(this.createObjectOffset(r));
      else
        throw new Error(
...
class $ {
  ...
  static getSizePrefixedRootAsKeyValue(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new $()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  key(t) {
  ...
  static createKeyValue(t, e, n) {
    return (
      $.startKeyValue(t), $.addKey(t, e), $.addValue(t, n), $.endKeyValue(t)
    );
  }
}
var me;
...
class it {
  ...
  static createInt(t, e, n) {
    return (
      it.startInt(t), it.addBitWidth(t, e), it.addIsSigned(t, n), it.endInt(t)
    );
  }
}
class Rt {
  ...
  static getSizePrefixedRootAsDictionaryEncoding(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new Rt()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  id() {
    const t = this.bb.__offset(this.bb_pos, 4);
  ...
  indexType(t) {
    const e = this.bb.__offset(this.bb_pos, 6);
    return e
      ? (t || new it()).__init(this.bb.__indirect(this.bb_pos + e), this.bb)
      : null;
  }
  isOrdered() {
...
class te {
  ...
  static getSizePrefixedRootAsBool(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new te()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  static startBool(t) {
    t.startObject(0);
...
class q {
  ...
  static getSizePrefixedRootAsDecimal(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new q()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  precision() {
    const t = this.bb.__offset(this.bb_pos, 4);
...
class It {
  ...
  static createFixedSizeBinary(t, e) {
    return (
      It.startFixedSizeBinary(t),
      It.addByteWidth(t, e),
      It.endFixedSizeBinary(t)
    );
  }
}
class St {
  ...
  static createFixedSizeList(t, e) {
    return (
      St.startFixedSizeList(t), St.addListSize(t, e), St.endFixedSizeList(t)
    );
  }
}
var ci;
...
class Bt {
  ...
  static createFloatingPoint(t, e) {
    return (
      Bt.startFloatingPoint(t), Bt.addPrecision(t, e), Bt.endFloatingPoint(t)
    );
  }
}
var li;
...
class ee {
  ...
  static getSizePrefixedRootAsList(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new ee()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  static startList(t) {
    t.startObject(0);
...
class ie {
  ...
  static getSizePrefixedRootAsNull(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new ie()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  static startNull(t) {
    t.startObject(0);
...
class ne {
  ...
  static getSizePrefixedRootAsStruct_(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new ne()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
...
class ot {
  ...
  static createTime(t, e, n) {
    return (
      ot.startTime(t), ot.addUnit(t, e), ot.addBitWidth(t, n), ot.endTime(t)
    );
  }
}
class at {
...
class X {
  ...
  static getSizePrefixedRootAsUnion(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new X()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  mode() {
    const t = this.bb.__offset(this.bb_pos, 4);
...
class re {
  ...
  static getSizePrefixedRootAsUtf8(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new re()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  static startUtf8(t) {
    t.startObject(0);
...
(function (i) {
  (i[(i.NONE = 0)] = "NONE"),
    ...
    (i[(i.RunEndEncoded = 22)] = "RunEndEncoded");
})(V || (V = {}));
class Y {
  constructor() {
    (this.bb = null), (this.bb_pos = 0);
  ...
  static getSizePrefixedRootAsField(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new Y()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  name(t) {
    const e = this.bb.__offset(this.bb_pos, 4);
  ...
  dictionary(t) {
    ...
    return e
      ? (t || new Rt()).__init(this.bb.__indirect(this.bb_pos + e), this.bb)
      : null;
  }
  children(t, e) {
...
class P {
  ...
  static getSizePrefixedRootAsSchema(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new P()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  endianness() {
    const t = this.bb.__offset(this.bb_pos, 4);
...
class et {
  ...
  static getSizePrefixedRootAsFooter(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new et()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  version() {
    const t = this.bb.__offset(this.bb_pos, 4);
  ...
  schema(t) {
    const e = this.bb.__offset(this.bb_pos, 6);
    return e
      ? (t || new P()).__init(this.bb.__indirect(this.bb_pos + e), this.bb)
      : null;
  }
  dictionaries(t, e) {
    const n = this.bb.__offset(this.bb_pos, 8);
...
class T {
  constructor(t = [], e, n) {
    (this.fields = t || []),
      (this.metadata = e || /* @__PURE__ */ new Map()),
      n || (n = ji(t)),
      (this.dictionaries = n);
  }
  get [Symbol.toStringTag]() {
  ...
  select(t) {
    const e = new Set(t),
      n = this.fields.filter((r) => e.has(r.name));
  ...
  assign(...t) {
    const e =
        t[0] instanceof T ? t[0] : Array.isArray(t[0]) ? new T(t[0]) : new T(t),
      n = [...this.fields],
      r = ke(ke(/* @__PURE__ */ new Map(), this.metadata), e.metadata),
      s = e.fields.filter((a) => {
        const c = n.findIndex((u) => u.name === a.name);
        return ~c
          ? (n[c] = a.clone({
              metadata: ke(
                ke(/* @__PURE__ */ new Map(), n[c].metadata),
                a.metadata
              ),
            })) && !1
          : !0;
...
class C {
  ...
  constructor(t, e, n = !1, r) {
    (this.name = t),
      (this.type = e),
      (this.nullable = n),
      (this.metadata = r || /* @__PURE__ */ new Map());
  }
  get typeId() {
    return this.type.typeId;
  }
...
class rn {
  static decode(t) {
    t = new ba(N(t));
    const e = et.getRootAsFooter(t),
      n = T.decode(e.schema());
    return new ga(n, e);
  }
  static encode(t) {
    const e = new ma(),
      n = T.encode(e, t.schema);
    et.startRecordBatchesVector(e, t.numRecordBatches);
    for (const o of [...t.recordBatches()].slice().reverse()) _e.encode(e, o);
    const r = e.endVector();
    ...
    return (
      et.startFooter(e),
      et.addSchema(e, n),
      et.addVersion(e, lt.V4),
      et.addRecordBatches(e, r),
      et.addDictionaries(e, s),
      et.finishFooterBuffer(e, et.endFooter(e)),
      e.asUint8Array()
    );
  }
...
class _e {
  ...
  static encode(t, e) {
    const { metaDataLength: n } = e,
      r = BigInt(e.offset),
      s = BigInt(e.bodyLength);
...
class _a extends is {
  ...
  close() {
    if (this._closedPromiseResolve) {
      ...
      for (; t.length > 0; ) t.shift().resolve(k);
...
class va extends _a {
  write(t) {
    if ((t = N(t)).byteLength > 0) return super.write(t);
  }
  toString(t = !1) {
...
class ve {
  constructor(t) {
    t instanceof ve
      ...
      : t instanceof va
      ? (this.source = new Xt(rt.fromAsyncIterable(t)))
      : zn(t)
      ? (this.source = new Xt(rt.fromNodeStream(t)))
      : Yi(t)
      ? (this.source = new Xt(rt.fromDOMStream(t)))
      : Cn(t)
      ? (this.source = new Xt(rt.fromDOMStream(t.body)))
      : wi(t)
      ? (this.source = new Xt(rt.fromIterable(t)))
      : Fe(t)
      ? (this.source = new Xt(rt.fromAsyncIterable(t)))
      : Wi(t) && (this.source = new Xt(rt.fromAsyncIterable(t)));
  }
  [Symbol.asyncIterator]() {
    return this;
  }
...
class In extends di {
  constructor(t, e) {
    super(),
      (this.position = 0),
      (this.buffer = N(t)),
      (this.size = e === void 0 ? this.buffer.byteLength : e);
  }
  readInt32(t) {
  ...
  read(t) {
    ...
    return e && r < n
      ? (typeof t != "number" && (t = Number.POSITIVE_INFINITY),
        (this.position = Math.min(n, r + Math.min(n - r, t))),
        e.subarray(r, this.position))
      : null;
  }
  readAt(t, e) {
    const n = this.buffer,
    ...
    return p(this, void 0, void 0, function* () {
      ...
      if (e && r < n) {
        ...
        let s = r,
          o = 0,
          a = 0;
        const c = Math.min(n, s + Math.min(n - s, t)),
...
const we = 8,
  sn = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8];
class ns {
  constructor(t) {
    this.buffer = t;
  }
...
class M extends ns {
  ...
  static fromString(t, e = new Uint32Array(2)) {
    const n = t.length,
      r = new M(e);
    for (let s = 0; s < n; ) {
      const o = we < n - s ? we : n - s,
        a = new M(new Uint32Array([Number.parseInt(t.slice(s, s + o), 10), 0])),
        c = new M(new Uint32Array([sn[o], 0]));
...
class Z extends ns {
  ...
  static fromString(t, e = new Uint32Array(2)) {
    const n = t.startsWith("-"),
      ...
      s = new Z(e);
    for (let o = n ? 1 : 0; o < r; ) {
      const a = we < r - o ? we : r - o,
        c = new Z(new Uint32Array([Number.parseInt(t.slice(o, o + a), 10), 0])),
        u = new Z(new Uint32Array([sn[a], 0]));
...
class gt {
  ...
  times(t) {
    const e = new M(new Uint32Array([this.buffer[3], 0])),
      n = new M(new Uint32Array([this.buffer[2], 0])),
      r = new M(new Uint32Array([this.buffer[1], 0])),
      s = new M(new Uint32Array([this.buffer[0], 0])),
      o = new M(new Uint32Array([t.buffer[3], 0])),
      a = new M(new Uint32Array([t.buffer[2], 0])),
      c = new M(new Uint32Array([t.buffer[1], 0])),
      u = new M(new Uint32Array([t.buffer[0], 0]));
    ...
    return (
      ...
      h.plus(d),
      (this.buffer[1] = h.low()),
      (this.buffer[3] = h.lessThan(d) ? 1 : 0),
      (this.buffer[2] = h.high()),
      new M(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset + 8, 2))
        .plus(M.multiply(n, u))
        .plus(M.multiply(r, c))
        .plus(M.multiply(s, a)),
      (this.buffer[3] += M.multiply(e, u)
        .plus(M.multiply(n, c))
        .plus(M.multiply(r, a))
        .plus(M.multiply(s, o))
        .low()),
  ...
  static fromString(t, e = new Uint32Array(4)) {
    ...
    for (let o = n ? 1 : 0; o < r; ) {
      const a = we < r - o ? we : r - o,
        ...
        u = new gt(new Uint32Array([sn[a], 0, 0, 0]));
      s.times(u), s.plus(c), (o += a);
    }
    return n ? s.negate() : s;
  }
...
class Sa extends rs {
  ...
  readData(t, { offset: e } = this.nextBufferRange()) {
    ...
    return f.isTimestamp(t) ||
      ((f.isInt(t) || f.isTime(t)) && t.bitWidth === 64) ||
      (f.isDate(t) && t.unit === Vt.MILLISECOND)
      ? R(Uint8Array, Z.convertArray(n[e]))
      : f.isDecimal(t)
      ? R(Uint8Array, gt.convertArray(n[e]))
      : f.isBinary(t) || f.isFixedSizeBinary(t)
      ? Ba(n[e])
      : f.isBool(t)
      ? Ci(n[e])
      : f.isUtf8(t)
...
class g extends O {
  compareSchemas(t, e) {
    return (
      t === e ||
      (e instanceof t.constructor && this.compareManyFields(t.fields, e.fields))
    );
  }
  compareManyFields(t, e) {
    return (
      ...
      (Array.isArray(t) &&
        Array.isArray(e) &&
        t.length === e.length &&
        t.every((n, r) => this.compareFields(n, e[r])))
    );
  }
  compareFields(t, e) {
    return (
...
function jt(i, t) {
  return (
    i === t ||
    (tt(i, t) && i.bitWidth === t.bitWidth && i.isSigned === t.isSigned)
  );
}
function Bi(i, t) {
...
function xe(i, t) {
  return (
    i === t || (tt(i, t) && i.unit === t.unit && i.timezone === t.timezone)
  );
}
function Ee(i, t) {
  return (
    i === t || (tt(i, t) && i.unit === t.unit && i.bitWidth === t.bitWidth)
  );
}
function Fa(i, t) {
  return (
    i === t ||
    (tt(i, t) &&
      i.children.length === t.children.length &&
      Gt.compareManyFields(i.children, t.children))
  );
}
function Oa(i, t) {
  return (
...
function an(i, t) {
  return (
    ...
    (tt(i, t) &&
      i.mode === t.mode &&
      i.typeIds.every((e, n) => e === t.typeIds[n]) &&
      Gt.compareManyFields(i.children, t.children))
  );
}
function Da(i, t) {
  return (
    ...
    (tt(i, t) &&
      i.id === t.id &&
      i.isOrdered === t.isOrdered &&
      Gt.visit(i.indices, t.indices) &&
      Gt.visit(i.dictionary, t.dictionary))
  );
}
function cn(i, t) {
  return i === t || (tt(i, t) && i.unit === t.unit);
...
function La(i, t) {
  const e = [...i.fields],
    n = [],
    r = { numBatches: t.reduce((h, A) => Math.max(h, A.length), 0) };
  let s = 0,
    o = 0,
    a = -1;
  const c = t.length;
  ...
  return [(i = i.assign(e)), n.map((h) => new J(i, h))];
}
  ...
  for (let a = -1, c = n.length; ++a < c; ) {
    ...
    if (d >= t)
      d === t
        ? (e[a] = u)
        : ((e[a] = u.slice(0, t)),
          (r.numBatches = Math.max(
            r.numBatches,
            n[a].unshift(u.slice(t, d - t))
          )));
    else {
      const h = i[a];
      (i[a] = h.clone({ nullable: !0 })),
        (e[a] =
          (s = u == null ? void 0 : u._changeLengthAndBackfillNullBitmap(t)) !==
            null && s !== void 0
            ? s
            : F({
                type: h.type,
...
class ct {
  constructor(...t) {
    ...
    let r, s;
    t[0] instanceof T && (r = t.shift()),
      t[t.length - 1] instanceof Uint32Array && (s = t.pop());
    const o = (c) => {
        if (c) {
          if (c instanceof J) return [c];
          if (c instanceof ct) return c.batches;
          if (c instanceof E) {
            if (c.type instanceof K) return [new J(new T(c.type.children), c)];
          } else {
            ...
            if (typeof c == "object") {
              const u = Object.keys(c),
                d = u.map((j) => new U([c[j]])),
                h = new T(u.map((j, nt) => new C(String(j), d[nt].type))),
                [, A] = Mi(h, d);
    ...
    (this.schema = r),
      (this.batches = a),
      (this._offsets = s != null ? s : Jr(this.data));
  }
  get data() {
  ...
  concat(...t) {
    const e = this.schema,
      n = this.data.concat(t.flatMap(({ data: r }) => r));
    return new ct(
      e,
      n.map((r) => new J(e, r))
    );
  ...
  getChildAt(t) {
    if (t > -1 && t < this.schema.fields.length) {
      ...
      if (e.length === 0) {
        const { type: n } = this.schema.fields[t],
          r = F({ type: n, length: 0, nullCount: 0 });
  ...
  select(t) {
    const e = this.schema.fields.reduce(
      (n, r, s) => n.set(r.name, s),
      /* @__PURE__ */ new Map()
    );
  ...
  selectAt(t) {
    const e = this.schema.selectAt(t),
      n = this.batches.map((r) => r.selectAt(t));
    return new ct(e, n);
  }
  assign(t) {
    const e = this.schema.fields,
      [n, r] = t.schema.fields.reduce(
        (a, c, u) => {
          const [d, h] = a,
            A = e.findIndex((j) => j.name === c.name);
...
ct[ss] = ((i) => (
  ...
  (i[Symbol.isConcatSpreadable] = !0),
  (i.isValid = pe(en)),
  (i.get = pe(Q.getVisitFn(l.Struct))),
  (i.set = Kr(ut.getVisitFn(l.Struct))),
  (i.indexOf = Gr(ri.getVisitFn(l.Struct))),
  (i.getByteLength = pe(Tt.getVisitFn(l.Struct))),
  "Table"
))(ct.prototype);
var os;
class J {
          ...
          (([
            ...
            this.data = F({
              ...
              children: this.schema.fields.map((e) =>
                F({ type: e.type, nullCount: 0 })
              ),
            }),
          ] = t),
          !(this.data instanceof E))
        )
          throw new TypeError(
            "RecordBatch constructor expects a [Schema, Data] pair."
          );
        ...
        const [e] = t,
          {
            ...
            (c, u, d) => (
              ...
              (c.fields[d] = C.new({ name: u, type: e[u].type, nullable: !0 })),
              c
            ),
            {
              length: 0,
          ...
          o = new T(n),
          a = F({ type: new K(n), length: s, children: r, nullCount: 0 });
  ...
  get dictionaries() {
    return (
      this._dictionaries ||
      (this._dictionaries = as(this.schema.fields, this.data.children))
    );
  }
  get numCols() {
    return this.schema.fields.length;
  ...
  setChildAt(t, e) {
    ...
    if (t > -1 && t < this.numCols) {
      ...
      ([s[t], o[t]] = [a, e.data[0]]),
        (n = new T(s, new Map(this.schema.metadata))),
        (r = F({ type: new K(s), children: o }));
    }
    return new J(n, r);
  }
  select(t) {
  ...
  selectAt(t) {
    const e = this.schema.selectAt(t),
      ...
      r = F({ type: new K(e.fields), length: this.numRows, children: n });
    return new J(e, r);
  }
}
os = Symbol.toStringTag;
J[os] = ((i) => (
  (i._nullCount = -1), (i[Symbol.isConcatSpreadable] = !0), "RecordBatch"
))(J.prototype);
function Sn(i, t, e = t.reduce((n, r) => Math.max(n, r.length), 0)) {
  ...
  return [i.assign(r), F({ type: new K(r), length: e, children: s })];
}
...
class cs extends J {
  constructor(t) {
    const e = t.fields.map((r) => F({ type: r.type })),
      n = F({ type: new K(t.fields), nullCount: 0, children: e });
    super(t, n);
  }
}
var fi;
...
class $t {
  ...
  static getSizePrefixedRootAsBodyCompression(t, e) {
    return (
      t.setPosition(t.position() + x),
      (e || new $t()).__init(t.readInt32(t.position()) + t.position(), t)
    );
  }
  codec() {
    const t = this.bb.__offset(this.bb_pos, 4);
  ...
  static createBodyCompression(t, e, n) {
    return (
      $t.startBodyCompression(t),
      $t.addCodec(t, e),
      $t.addMethod(t, n),
      $t.endBodyCompression(t)
    );
  }
}
class ls {
  ...
  static createBuffer(t, e, n) {
    return (
      t.prep(8, 16),
      t.writeInt64(BigInt(n != null ? n : 0)),
      t.writeInt64(BigInt(e != null ? e : 0)),
      t.offset()
    );
  }
...
class st {
  ...
  compression(t) {
    const e = this.bb.__offset(this.bb_pos, 10);
    return e
      ? (t || new $t()).__init(this.bb.__indirect(this.bb_pos + e), this.bb)
      : null;
  }
...
class Ra extends O {
  ...
  visitInt(t, e) {
    return (
      it.startInt(e),
      it.addBitWidth(e, t.bitWidth),
      it.addIsSigned(e, t.isSigned),
      it.endInt(e)
    );
  }
  visitFloat(t, e) {
    return (
      Bt.startFloatingPoint(e),
      Bt.addPrecision(e, t.precision),
      Bt.endFloatingPoint(e)
    );
  }
  visitBinary(t, e) {
  ...
  visitDecimal(t, e) {
    return (
      q.startDecimal(e),
      q.addScale(e, t.scale),
      q.addPrecision(e, t.precision),
      q.addBitWidth(e, t.bitWidth),
      q.endDecimal(e)
    );
  }
  visitDate(t, e) {
  ...
  visitUnion(t, e) {
    ...
    return (
      X.startUnion(e), X.addMode(e, t.mode), X.addTypeIds(e, n), X.endUnion(e)
    );
  }
  visitDictionary(t, e) {
    const n = this.visit(t.indices, e);
    return (
      Rt.startDictionaryEncoding(e),
      Rt.addId(e, BigInt(t.id)),
      Rt.addIsOrdered(e, t.isOrdered),
      n !== void 0 && Rt.addIndexType(e, n),
      Rt.endDictionaryEncoding(e)
    );
  }
  visitFixedSizeBinary(t, e) {
    return (
      It.startFixedSizeBinary(e),
      It.addByteWidth(e, t.byteWidth),
      It.endFixedSizeBinary(e)
    );
  }
  visitFixedSizeList(t, e) {
    return (
      St.startFixedSizeList(e),
      St.addListSize(e, t.listSize),
      St.endFixedSizeList(e)
    );
  }
  visitMap(t, e) {
...
function hs(i) {
  return (i || []).reduce(
    (t, e) => [...t, new Se(e.count, Va(e.VALIDITY)), ...hs(e.children)],
    []
  );
}
function fs(i, t = []) {
  for (let e = -1, n = (i || []).length; ++e < n; ) {
    const r = i[e];
    r.VALIDITY && t.push(new Et(t.length, r.VALIDITY.length)),
      r.TYPE && t.push(new Et(t.length, r.TYPE.length)),
      r.OFFSET && t.push(new Et(t.length, r.OFFSET.length)),
      r.DATA && t.push(new Et(t.length, r.DATA.length)),
      (t = fs(r.children, t));
  }
  return t;
}
...
function za(i, t) {
  ...
  return (
    !t || !(s = i.dictionary)
      ? ((o = Fn(i, Bn(i, t))),
        (r = new C(i.name, o, i.nullable, Pe(i.customMetadata))))
      : t.has((e = s.id))
      ? ((n = (n = s.indexType) ? An(n) : new Ne()),
        (a = new ye(t.get(e), n, e, s.isOrdered)),
        (r = new C(i.name, a, i.nullable, Pe(i.customMetadata))))
      : ((n = (n = s.indexType) ? An(n) : new Ne()),
        t.set(e, (o = Fn(i, Bn(i, t)))),
        (a = new ye(o, n, e, s.isOrdered)),
        (r = new C(i.name, a, i.nullable, Pe(i.customMetadata)))),
    r || null
  );
}
...
class ht {
  ...
  static encode(t) {
    ...
    return (
      t.isSchema()
        ? (n = T.encode(e, t.header()))
        : t.isRecordBatch()
        ? (n = mt.encode(e, t.header()))
        : t.isDictionaryBatch() && (n = zt.encode(e, t.header())),
      W.startMessage(e),
      W.addVersion(e, lt.V4),
      W.addHeader(e, n),
      W.addHeaderType(e, t.headerType),
      W.addBodyLength(e, BigInt(t.bodyLength)),
      W.finishMessageBuffer(e, W.endMessage(e)),
      e.asUint8Array()
    );
  }
  static from(t, e = 0) {
    if (t instanceof T) return new ht(0, lt.V4, L.Schema, t);
    if (t instanceof mt) return new ht(e, lt.V4, L.RecordBatch, t);
    if (t instanceof zt) return new ht(e, lt.V4, L.DictionaryBatch, t);
  ...
  constructor(t, e, n, r) {
    (this._version = e),
      ...
      r && (this._createHeader = () => r),
      (this._bodyLength = yt(t));
  }
}
class mt {
  get nodes() {
...
function Za(i, t) {
  ...
  for (let n, r = -1, s = -1, o = i.buffersLength(); ++r < o; )
    (n = i.buffers(r)) &&
      (t < lt.V4 && (n.bb_pos += 8 * (r + 1)), (e[++s] = Et.decode(n)));
  return e;
}
function qa(i, t) {
  const e = [];
...
function Xa(i, t) {
  ...
  return (
    !t || !(a = i.dictionary())
      ? ((r = Nn(i, On(i, t))), (n = new C(i.name(), r, i.nullable(), $e(i))))
      : t.has((e = yt(a.id())))
      ? ((s = (s = a.indexType()) ? Dn(s) : new Ne()),
        (o = new ye(t.get(e), s, e, a.isOrdered())),
        (n = new C(i.name(), o, i.nullable(), $e(i))))
      : ((s = (s = a.indexType()) ? Dn(s) : new Ne()),
        t.set(e, (r = Nn(i, On(i, t)))),
        (o = new ye(r, s, e, a.isOrdered())),
        (n = new C(i.name(), o, i.nullable(), $e(i)))),
    n || null
  );
}
...
function Qa(i, t) {
  ...
  const n = P.createFieldsVector(i, e),
    r =
      t.metadata && t.metadata.size > 0
        ? P.createCustomMetadataVector(
            i,
            [...t.metadata].map(([s, o]) => {
              const a = i.createString(`${s}`),
                c = i.createString(`${o}`);
              return (
                $.startKeyValue(i),
                $.addKey(i, a),
  ...
  return (
    P.startSchema(i),
    P.addFields(i, n),
    P.addEndianness(i, sc ? be.Little : be.Big),
    r !== -1 && P.addCustomMetadata(i, r),
    P.endSchema(i)
  );
}
function tc(i, t) {
  ...
  f.isDictionary(s)
    ? ((o = s.dictionary.typeId),
      (r = Li.visit(s, i)),
      (n = Li.visit(s.dictionary, i)))
    : (n = Li.visit(s, i));
  const a = (s.children || []).map((d) => C.encode(i, d)),
    c = Y.createChildrenVector(i, a),
    u =
      t.metadata && t.metadata.size > 0
        ? Y.createCustomMetadataVector(
            i,
            [...t.metadata].map(([d, h]) => {
              const A = i.createString(`${d}`),
                j = i.createString(`${h}`);
              return (
                $.startKeyValue(i),
                $.addKey(i, A),
        ...
        : -1;
  return (
    t.name && (e = i.createString(t.name)),
    Y.startField(i),
    Y.addType(i, n),
    Y.addTypeType(i, o),
    Y.addChildren(i, c),
    Y.addNullable(i, !!t.nullable),
    e !== -1 && Y.addName(i, e),
    r !== -1 && Y.addDictionary(i, r),
    u !== -1 && Y.addCustomMetadata(i, u),
    Y.endField(i)
  );
}
function ec(i, t) {
  ...
  for (const o of e.slice().reverse()) Se.encode(i, o);
  const r = i.endVector();
  st.startBuffersVector(i, n.length);
  for (const o of n.slice().reverse()) Et.encode(i, o);
  const s = i.endVector();
  return (
    st.startRecordBatch(i),
    st.addLength(i, BigInt(t.length)),
    st.addNodes(i, r),
    st.addBuffers(i, s),
    st.endRecordBatch(i)
  );
...
function ic(i, t) {
  ...
  return (
    xt.startDictionaryBatch(i),
    xt.addId(i, BigInt(t.id)),
    xt.addIsDelta(i, t.isDelta),
    xt.addData(i, e),
    xt.endDictionaryBatch(i)
  );
}
function nc(i, t) {
...
const sc = (() => {
  ...
  ln = (i) => `Expected ${L[i]} Message in stream, but was null or length 0.`,
  un = (i) =>
    `Header pointer of flatbuffer-encoded ${L[i]} Message is null or length 0.`,
  ps = (i, t) => `Expected to read ${i} metadata bytes, but only read ${t}.`,
  ys = (i, t) =>
    `Expected to read ${i} bytes for message body, but only read ${t}.`;
class ms {
  constructor(t) {
  ...
  readMessage(t) {
    ...
    if (t != null && e.value.headerType !== t) throw new Error(ln(t));
    return e.value;
  }
  readMessageBody(t) {
  ...
  readSchema(t = !1) {
    ...
    if (t && !r) throw new Error(un(e));
    return r;
  }
  readMetadataLength() {
    const t = this.source.read(Ai),
      e = t && new Kt(t),
  ...
  readMetadata(t) {
    ...
    if (!e) return k;
    if (e.byteLength < t) throw new Error(ps(t, e.byteLength));
...
class oc {
  ...
  readMetadataLength() {
    return p(this, void 0, void 0, function* () {
      const t = yield this.source.read(Ai),
        e = t && new Kt(t),
        n = (e == null ? void 0 : e.readInt32(0)) || 0;
      return { done: n === 0, value: n };
    });
...
class ac extends ms {
  constructor(t) {
    super(new Uint8Array(0)),
      ...
      (this._json = t instanceof wn ? t : new wn(t));
  }
  next() {
    const { _json: t } = this;
    if (!this._schema)
    ...
    if (this._batchIndex < t.batches.length) {
      ...
      return (
        ...
        { done: !1, value: ht.fromJSON(e, L.RecordBatch) }
      );
    }
    return (this._body = []), k;
  }
  ...
  readSchema() {
    ...
    if (!e || !n) throw new Error(un(t));
    return n;
  }
}
const Ai = 4,
  Pi = "ARROW1",
  mi = new Uint8Array(Pi.length);
for (let i = 0; i < Pi.length; i += 1) mi[i] = Pi.codePointAt(i);
function dn(i, t = 0) {
  for (let e = -1, n = mi.length; ++e < n; ) if (mi[e] !== i[t + e]) return !1;
  return !0;
}
const Ce = mi.length,
  bs = Ce + Ai,
  ...
  static readAll(t) {
    return t instanceof Ct
      ? t.isSync()
        ? Tn(t)
        : Mn(t)
      : xi(t) || ArrayBuffer.isView(t) || wi(t) || xn(t)
      ? Tn(t)
      : Mn(t);
  }
}
...
class _s {
  ...
  _loadRecordBatch(t, e) {
    const n = this._loadVectors(t, e, this.schema.fields),
      r = F({ type: new K(this.schema.fields), length: t.length, children: n });
    return new J(this.schema, r);
  }
  _loadDictionaryBatch(t, e) {
    const { id: n, isDelta: r } = t,
      { dictionaries: s, schema: o } = this,
      a = s.get(n);
    if (r || !a) {
      const c = o.dictionaries.get(n),
...
class _i extends _s {
  constructor(t, e) {
    super(e),
      (this._reader = xi(t)
        ? new ac((this._handle = t))
        : new ms((this._handle = t)));
  }
  isSync() {
    return !0;
  }
  ...
  next() {
    ...
    for (; (t = this._readNextMessageAndValidate()); )
      if (t.isSchema()) this.reset(t.header());
        ...
        const n = t.header(),
          r = e.readMessageBody(t.bodyLength),
          s = this._loadDictionaryBatch(n, r);
        this.dictionaries.set(n.id, s);
      }
    return this.schema && this._recordBatchIndex === 0
      ? (this._recordBatchIndex++, { done: !1, value: new cs(this.schema) })
      : this.return();
  }
...
class uc extends vi {
  ...
  constructor(t, ...e) {
    const n = typeof e[0] != "number" ? e.shift() : void 0,
...
function fc(i) {
  ...
  return t && t.byteLength >= 4
    ? dn(t)
      ? new gs(new vs(i.read()))
      : new bi(new _i(i))
    : new bi(new _i((function* () {})()));
}
function pc(i) {
  return p(this, void 0, void 0, function* () {
...
function yc(i) {
  return p(this, void 0, void 0, function* () {
    const { size: t } = yield i.stat(),
      e = new hi(i, t);
    return t >= cc && dn(yield e.readAt(0, (Ce + 7) & -8))
      ? new lc(new uc(e))
      : new gi(new vi(e));
  });
}
function Is(i) {
  ...
  return Fe(t)
    ? t.then((e) => Is(e))
    : t.isAsync()
    ? t.readAll().then((e) => new ct(e))
    : new ct(t.readAll());
}
function z(i) {
  return (
    i != null && typeof i == "object" && i["@@functional/placeholder"] === !0
  );
}
function Dt(i) {
  return function t(e) {
...
var gc = /* @__PURE__ */ (function () {
  ...
  return (
    (i.prototype["@@transducer/init"] = function () {
...
function Ic(i, t, e) {
  for (var n = 0, r = e.length; n < r; ) {
    if (
      ((t = i["@@transducer/step"](t, e[n])), t && t["@@transducer/reduced"])
    ) {
...
function Ln(i, t, e) {
  for (var n = e.next(); !n.done; ) {
    if (
      ((t = i["@@transducer/step"](t, n.value)), t && t["@@transducer/reduced"])
    ) {
      t = t["@@transducer/value"];
      break;
    }
...
function Sc(i, t, e) {
  if ((typeof i == "function" && (i = _c(i)), bc(e))) return Ic(i, t, e);
  if (typeof e["fantasy-land/reduce"] == "function")
    return Un(i, t, e, "fantasy-land/reduce");
  if (e[Rn] != null) return Ln(i, t, e[Rn]());
  if (typeof e.next == "function") return Ln(i, t, e);
  if (typeof e.reduce == "function") return Un(i, t, e, "reduce");
...
function Os(i, t) {
  return function () {
    ...
    if (e === 0) return t();
    var n = arguments[e - 1];
    return As(n) || typeof n[i] != "function"
      ? t.apply(this, arguments)
      : n[i].apply(n, Array.prototype.slice.call(arguments, 0, e - 1));
  };
}
var Oc = /* @__PURE__ */ Bs(
...
const Dc = Oc;
var Nc = /* @__PURE__ */ Dt(
  /* @__PURE__ */ Os("tail", /* @__PURE__ */ Dc(1, 1 / 0))
);
const Tc = Nc;
function Mc() {
...
class Ec {
  constructor(t) {
    ...
    for (const e of t)
      f.isTimestamp(e)
        ? this.composeTimestampField(e)
        : f.isInt(e)
        ? this.composeIntField(e)
        : f.isFloat(e) && this.composeFloatField(e),
        this.fieldNames.push(e.name);
  }
  composeIntField(t) {
  ...
  composeTimestampField(t) {
    (t.type.timezone === null || t.type.timezone === "UTC") &&
      (this.coerceRow = Ui((e) => {
        const n = e[t.name];
...
const We = (i) => {
  ...
  jc = (i) => {
    const t = [],
      e = Is(i),
      n = new Ec(e.schema.fields);
    for (const r of e) t.push(n.coerceRow(r));
    return {
      schema: Cc(e.schema),
      data: t,
...
export { jc as apiResponseToArrow };
