...
const z = /* @__PURE__ */ e(
  ...
  M = { class: "flex-1 flex justify-between px-4 sm:px-6" },
  U = { class: "flex-1 flex" },
  A = { class: "w-full flex md:ml-0" },
  F = { class: "relative w-full text-gray-400 focus-within:text-gray-600" },
  V = /* @__PURE__ */ e(
    "div",
    {
  ...
  H = [E],
  J = { class: "bg-gray-100 p-3 w-full flex items-center" },
  R = { class: "flex items-center mr-4" },
  I = ["checked"],
  N = /* @__PURE__ */ e(
    "label",
    {
  ...
  O = /* @__PURE__ */ w({
    ...
    setup(f) {
      const _ = f,
        ...
        d = o(r("owned_by_me") === "on"),
        u = o(r("project")),
        g = o(r("name")),
        a = o(!!u.value || d.value || !1),
        h = o(),
        x = () => (a.value = !a.value);
      return (t, s) => (
        c(),
                        ...
                        e("div", F, [
                          ...
                          e(
                            "input",
                            {
                              ...
                              id: "id_name",
                              class:
                                "h-full w-full border-transparent py-2 pl-8 pr-3 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 focus:border-transparent focus:placeholder-gray-400 sm:block",
                      ...
                      [
                        e(
                          "button",
                          {
                            ...
                            onClick: x,
                            class:
                              "justify-center px-3.5 py-2 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500",
                          },
                          H
                        ),
                      ]
